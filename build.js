...
var _chromeDebug = require('alt/utils/chromeDebug');

var _chromeDebug2 = _interopRequireWildcard(_chromeDebug);

var _cache = require('./cache');

var _cache2 = _interopRequireWildcard(_cache);

var alt = new _Alt2['default']();
_chromeDebug2['default'](alt);

var StargazerActions = alt.generateActions('load', 'fire');
...
var Store = (function () {
  ...
  _createClass(_Store, [{
    ...
    key: 'displayName',
    value: 'StargazerStore',
    enumerable: true
  }]);

  Store = _cache2['default']()(Store) || Store;
  return Store;
})();

var StargazerStore = alt.createStore(Store, 'StargazerStore');
...
},{"./cache":3,"alt":8,"alt/utils/chromeDebug":16}],2:[function(require,module,exports){
'use strict';
...
var _Stargazers = require('./stargazers');

var _Stargazers2 = _interopRequireWildcard(_Stargazers);

var _Count = require('./count');

var _Count2 = _interopRequireWildcard(_Count);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _React2['default'].createElement(
        ...
        _React2['default'].createElement(
          'button',
          { onClick: this.doChange.bind(this) },
          'Go'
        ),
        _React2['default'].createElement(_Count2['default'], { user: this.state.user, repo: this.state.repo }),
        _React2['default'].createElement(_Stargazers2['default'], { user: this.state.user, repo: this.state.repo })
      );
    }
  }]);
...
},{"./alt":1,"./count":4,"./stargazers":210,"alt/components/AltContainer":6,"react":207}],3:[function(require,module,exports){
'use strict';
...
function cache() {
  ...
  return function (Store) {
    var cache = _LRU2['default'](_assign2['default']({
    ...
    // XXX should the cache only have one key since the store only deals with a single domain?
    // this makes invalidating the cache easier because I just reset that key

    var CacheStore = (function (_Store) {
      function CacheStore() {
        ...
        _get(Object.getPrototypeOf(CacheStore.prototype), 'constructor', this).apply(this, args);

        this.exportPublicMethods({
          cacheValue: function cacheValue(key, value) {
            cache.set(key, value);
            return value;
          },

          source: function source(config) {
            var _this4 = this;

            var key = config.key;

            var remote = _objectWithoutProperties(config, ['key']);
            ...
            return new Promise(function (resolve, reject) {
              var value = cache.has(cacheKey) ? cache.get(cacheKey) : undefined;

              if (value === undefined) {
                inFlightRequests[id] = _axios2['default'](remote);
              ...
              return _this4.cacheValue(cacheKey, value);
            });
          },
...
},{"axios":17,"lru-cache":33,"object-assign":34}],4:[function(require,module,exports){
'use strict';
...
var _StargazerSource = require('./sources/StargazerSource');

var _StargazerSource2 = _interopRequireWildcard(_StargazerSource);

var Count = (function (_React$Component) {
  function Count(props) {
    _classCallCheck(this, _Count);

    _get(Object.getPrototypeOf(_Count.prototype), 'constructor', this).call(this, props);
  }
  ...
  Count = _data2['default'](_assign2['default']({
  ...
  }, _StargazerSource2['default']))(Count) || Count;
  return Count;
})(_React2['default'].Component);
...
},{"./data":5,"./sources/StargazerSource":209,"object-assign":34,"react":207}],5:[function(require,module,exports){
'use strict';
  ...
  return function (Component) {
    return _React2['default'].createClass({
      ...
      componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
        ...
        var areEqual = Object.keys(nextProps).reduce(function (equals, prop) {
          return equals && nextProps[prop] === _this.props[prop];
        }, true);
      ...
      resolveState: function resolveState(props) {
        var _this2 = this;
        ...
        // XXX I think the batching should be done by this instead
        var promises = Object.keys(config.data).map(function (key) {
          return new Promise(function (resolve, reject) {
            var callback = function callback(err, value) {
              return err ? reject(err) : resolve(value);
            };
            var value = config.data[key](props, callback);
        ...
        Promise.all(promises).then(function () {
          _this2.setState({ values: values, status: STAT.DONE });
        }, function (error) {
          _this2.setState({ error: error, status: STAT.FAILED });
        });
      },
      ...
      render: function render() {
        ...
        switch (status) {
          case STAT.READY:
            return null;
          case STAT.DONE:
            return _React2['default'].createElement(Component, this.state.values);
          case STAT.LOADING:
            return config.loading ? this.renderIfValid(config.loading(this.props)) : null;
          case STAT.FAILED:
            return config.failed ? this.renderIfValid(config.failed(this.state.error)) : null;
        }
      }
    });
  };
...
},{"./mixinContainer":7,"object-assign":15,"react/addons":35}],7:[function(require,module,exports){
...
},{"../mixins/Subscribe":9,"object-assign":15}],8:[function(require,module,exports){
"use strict";
...
},{"es-symbol":10,"eventemitter3":11,"flux":12,"object-assign":15}],9:[function(require,module,exports){
'use strict'
...
},{"es-symbol":10}],10:[function(require,module,exports){
"use strict";
...
},{"./../defaults":22,"./../helpers/buildUrl":23,"./../helpers/cookies":24,"./../helpers/parseHeaders":26,"./../helpers/transformData":28,"./../helpers/urlIsSameOrigin":29,"./../utils":30}],19:[function(require,module,exports){
'use strict';
...
},{"./core/InterceptorManager":20,"./core/dispatchRequest":21,"./defaults":22,"./helpers/deprecatedMethod":25,"./helpers/spread":27,"./utils":30,"es6-promise":31}],20:[function(require,module,exports){
'use strict';
...
},{"../adapters/http":18,"../adapters/xhr":18,"_process":32}],22:[function(require,module,exports){
'use strict';
...
},{"./invariant":185,"_process":32}],39:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSProperty":39,"./ExecutionEnvironment":56,"./camelizeStyleName":156,"./dangerousStyleValue":163,"./hyphenateStyleName":183,"./memoizeStringOnly":194,"./warning":206,"_process":32}],41:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":63,"./PooledClass":64,"./invariant":185,"_process":32}],42:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":47,"./ReactMultiChildUpdateTypes":113,"./invariant":185,"./setTextContent":200,"_process":32}],45:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":185,"_process":32}],46:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":45,"./quoteAttributeValueForBrowser":198,"./warning":206,"_process":32}],47:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":56,"./createNodesFromMarkup":161,"./emptyFunction":164,"./getMarkupWrap":177,"./invariant":185,"_process":32}],48:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./emptyFunction":164,"_process":32}],52:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventPluginRegistry":53,"./EventPluginUtils":54,"./accumulateInto":153,"./forEachAccumulated":170,"./invariant":185,"_process":32}],53:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":185,"_process":32}],54:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":50,"./invariant":185,"_process":32}],55:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":50,"./EventPluginHub":52,"./accumulateInto":153,"./forEachAccumulated":170,"_process":32}],56:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypes":120,"./invariant":185,"_process":32}],61:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactBrowserEventEmitter":67,"./accumulateInto":153,"./forEachAccumulated":170,"./invariant":185,"_process":32}],62:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":185,"_process":32}],65:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventPluginUtils":54,"./ExecutionEnvironment":56,"./Object.assign":63,"./ReactChildren":71,"./ReactClass":72,"./ReactComponent":73,"./ReactContext":78,"./ReactCurrentOwner":79,"./ReactDOM":80,"./ReactDOMTextComponent":91,"./ReactDefaultInjection":94,"./ReactElement":97,"./ReactElementValidator":98,"./ReactInstanceHandles":106,"./ReactMount":111,"./ReactPerf":116,"./ReactPropTypes":120,"./ReactReconciler":123,"./ReactServerRendering":126,"./findDOMNode":167,"./onlyChild":195,"_process":32}],66:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSCore":38,"./React":65,"./ReactTransitionEvents":131,"./onlyChild":195,"./warning":206,"_process":32}],70:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":64,"./ReactFragment":103,"./traverseAllChildren":204,"./warning":206,"_process":32}],72:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactUpdateQueue":133,"./invariant":185,"./warning":206,"_process":32}],74:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":185,"_process":32}],76:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"./emptyObject":165,"./warning":206,"_process":32}],79:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":97,"./ReactElementValidator":98,"./mapObject":193,"_process":32}],81:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSPropertyOperations":40,"./DOMChildrenOperations":44,"./DOMPropertyOperations":46,"./ReactMount":111,"./ReactPerf":116,"./invariant":185,"./setInnerHTML":199,"_process":32}],85:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":36,"./DOMPropertyOperations":46,"./LinkedValueUtils":60,"./Object.assign":63,"./ReactBrowserComponentMixin":66,"./ReactClass":72,"./ReactElement":97,"./ReactMount":111,"./ReactUpdates":134,"./invariant":185,"_process":32}],88:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactBrowserComponentMixin":66,"./ReactClass":72,"./ReactElement":97,"./warning":206,"_process":32}],89:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":36,"./DOMPropertyOperations":46,"./LinkedValueUtils":60,"./Object.assign":63,"./ReactBrowserComponentMixin":66,"./ReactClass":72,"./ReactElement":97,"./ReactUpdates":134,"./invariant":185,"./warning":206,"_process":32}],93:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"./ReactContext":78,"./ReactCurrentOwner":79,"./warning":206,"_process":32}],98:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":79,"./ReactElement":97,"./ReactFragment":103,"./ReactNativeComponent":114,"./ReactPropTypeLocationNames":118,"./ReactPropTypeLocations":119,"./getIteratorFn":176,"./invariant":185,"./warning":206,"_process":32}],99:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":97,"./ReactInstanceMap":107,"./invariant":185,"_process":32}],100:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":97,"./warning":206,"_process":32}],104:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":125,"./invariant":185,"_process":32}],107:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"./invariant":185,"_process":32}],115:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":185,"_process":32}],116:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElementValidator":98,"./ReactRef":124,"_process":32}],124:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":97,"./ReactInstanceHandles":106,"./ReactMarkupChecksum":110,"./ReactServerRenderingTransaction":127,"./emptyObject":165,"./instantiateReactComponent":184,"./invariant":185,"_process":32}],127:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"./ReactCurrentOwner":79,"./ReactElement":97,"./ReactInstanceMap":107,"./ReactLifeCycle":108,"./ReactUpdates":134,"./invariant":185,"./warning":206,"_process":32}],134:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":41,"./Object.assign":63,"./PooledClass":64,"./ReactCurrentOwner":79,"./ReactPerf":116,"./ReactReconciler":123,"./Transaction":151,"./invariant":185,"./warning":206,"_process":32}],135:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedStateMixin":59,"./React":65,"./ReactCSSTransitionGroup":68,"./ReactComponentWithPureRenderMixin":76,"./ReactDefaultPerf":95,"./ReactFragment":103,"./ReactTestUtils":129,"./ReactTransitionGroup":132,"./ReactUpdates":134,"./cloneWithProps":157,"./cx":162,"./update":205,"_process":32}],136:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":185,"_process":32}],152:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":185,"_process":32}],154:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":97,"./ReactPropTransferer":117,"./keyOf":192,"./warning":206,"_process":32}],158:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactClass":72,"./ReactElement":97,"./invariant":185,"_process":32}],161:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":56,"./createArrayFromMixed":159,"./getMarkupWrap":177,"./invariant":185,"_process":32}],162:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./warning":206,"_process":32}],163:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":32}],166:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":79,"./ReactInstanceMap":107,"./ReactMount":111,"./invariant":185,"./isNode":187,"./warning":206,"_process":32}],168:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":204,"./warning":206,"_process":32}],169:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":56,"./invariant":185,"_process":32}],178:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":63,"./ReactCompositeComponent":77,"./ReactEmptyComponent":99,"./ReactNativeComponent":114,"./invariant":185,"./warning":206,"_process":32}],185:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":185,"_process":32}],192:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":97,"./invariant":185,"_process":32}],196:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./warning":206,"_process":32}],203:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":185,"_process":32}],204:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":97,"./ReactFragment":103,"./ReactInstanceHandles":106,"./getIteratorFn":176,"./invariant":185,"./warning":206,"_process":32}],205:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":63,"./invariant":185,"./keyOf":192,"_process":32}],206:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./emptyFunction":164,"_process":32}],207:[function(require,module,exports){
...
function source(config) {
  ...
  return new Promise(function (resolve, reject) {
    inFlightRequests[id] = _axios2['default'](config);
    inFlightRequests[id].then(resolve)['catch'](reject);
  }).then(function (value) {
    delete inFlightRequests[id];
    return value;
...
},{"axios":17}],209:[function(require,module,exports){
'use strict';
...
var _source2 = _interopRequireWildcard(_source);

var StargazerStore = _alt2['default'].stores.StargazerStore;

exports['default'] = {
  data: {
    users: function users(props) {
      var url = 'https://api.github.com/repos/' + props.user + '/' + props.repo + '/stargazers';
      return _source2['default']({ url: url }).then(function (response) {
        return response.data;
      });
    } } };
module.exports = exports['default'];

},{"../alt":1,"../source":208}],210:[function(require,module,exports){
'use strict';
...
var Stargazers = (function (_React$Component) {
  ...
  Stargazers = _data2['default'](_assign2['default']({
    loading: function loading(props) {
      return _React2['default'].createElement(
        'div',
        null,
    ...
    failed: function failed(error) {
      return _React2['default'].createElement(
        'div',
        null,
        error.stack || error.statusText || error
      );
    }
  }, _StargazerSource2['default']))(Stargazers) || Stargazers;
  return Stargazers;
})(_React2['default'].Component);
...
},{"./data":5,"./sources/StargazerSource":209,"object-assign":34,"react":207}]},{},[2]);
